...
.CODE
   MAIN PROC
     ...
     @INPUT:                      ; loop label
       ...
       JLE @SKIP_UPDATE_1       ; jump to label @SKIP_UPDATE_1 if CL<=DL

       MOV DH, BH                 ; set DH=BH
       MOV DL, CL                 ; set DL=CL

       @SKIP_UPDATE_1:          ; jump label
     ...
     CMP CL, DL                   ; compare CL with DL
     JLE @SKIP_UPDATE_2         ; jump to label @SKIP_UPDATE_2 if CL<=DL

     MOV DH, BH                   ; set DH=BH
     MOV DL, CL                   ; set DL=CL

     @SKIP_UPDATE_2:            ; jump label
